...
import { Enterprise as Model  } from "../../../database/mongo";
import { IEnterprise as TypeModel} from '../../../utils/interface/enterprise/IEnterprise';
...
export async function create(data : TypeModel) {
    ...
    try {
        ...
        logger.error(`enterprise|${error.message}`)
