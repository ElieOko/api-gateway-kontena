...
import { Workspace as Model  } from "../../../database/mongo";
import { IWorkSpace as TypeModel} from '../../../utils/interface/workspace/IWorkSpace';
...
export async function create(data : TypeModel) {
    ...
    try {
        ...
        logger.error(`workspace|${error.message}`)
