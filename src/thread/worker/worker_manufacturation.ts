...
import { axiosRequestServerManufacturation } from "../../config/request/axios/requestServerToServer";
...
export const createUserExtend = async () => {
    let data = "";
    try {
      const response = await axiosRequestServerManufacturation().post('register', userExtend);
...
export  const serviceManufacturation = async() => {
