...
import { axiosRequestServerVente } from "../../config/request/axios/requestServerToServer";
...
export const createUserExtend = async () => {
    let data = "";
    try {
      const response = await axiosRequestServerVente().post('register', userExtend);
...
export  const serviceVente = async() => {
